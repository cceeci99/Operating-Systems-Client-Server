...
***ΣΧΟΛΙΟ : Το παιδι που θα προλάβει να κάνει πρώτο down τον σημαφόρο (client_to_other_clients) μπλοκάρει τα υπόλοιπα, υποβάλει το αίτημα του και περιμένει τον server να του απαντήσει. Επειτα εκτυπώνει τη γραμμή  και κάνει up τον σημαφόρο (client_to_other_clients). Στις περισσότερες περιπτώσεις όμως και ειδικότερα αν συμμετέχει μικρό πληθος παιδιων και αιτημάτων, παρατηρείται οτι το τρέχον παιδί προλαβαίνει να υποβάλει πρώτα ολα τα αιτήματα τού , προτού μπει καποιο αλλο παιδί να εκτελέσει το critical section τού. Επομένως τα αιτήματα εμφανίζονται με την σειρά. Για αυτό χρησιμοποιείται μια usleep(1) η οποία κάνει το τρέχον παιδί να κοιμηθεί για 1 milisecond έτσι ώστε να προλάβει καποιο άλλο τυχαίο να υποβάλει αίτημα.
------------------
